...
class BookingMethodDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BookingMethodDialog> createState() =>
      _BookingMethodDialogState();
}
...
class _BookingMethodDialogState extends ConsumerState<BookingMethodDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Text(
        isEdit ? 'Edit Booking Method' : 'Add Booking Method',
