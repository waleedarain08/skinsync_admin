...
enum Endpoint {
  ...
  clinicPlans('admin/clinic-subscription-plans'),
  updateClinicPlan('admin/clinic-subscription-plans/{id}'),
  deleteClinicPlan('admin/clinic-subscription-plans/{id}'),
  ...
  postTag('admin/community-post/tags'),
