...
class ManageTreatmentDataScreen extends ConsumerWidget {
  ...
  static void _showCategoryCreationDialog({
    ...
    required Function(String, String, PlatformFile?, List<SessionConfig>?, List<NotificationConfig>?, List<NotificationConfig>?, DowntimePresets?, List<String>?) onConfirm,
  }) async {
            ...
            IconButton(
              ...
              onPressed: () => ManageTreatmentDataScreen._showCategoryCreationDialog(
                ...
                onConfirm: (name, icon, consentFile, sessions, preNotif, postNotif, downtime, roles) => viewModel.editCategory(
                  ...
                  preNotifications: preNotif ?? category.preNotifications,
                  postNotifications: postNotif ?? category.postNotifications,
