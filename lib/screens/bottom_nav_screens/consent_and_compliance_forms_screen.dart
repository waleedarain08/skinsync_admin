...
class ConsentAndComplianceFormsScreen extends ConsumerStatefulWidget {
  static const String routeName = '/consent-and-compliance-forms';
  const ConsentAndComplianceFormsScreen({super.key});

  @override
  ConsumerState<ConsentAndComplianceFormsScreen> createState() =>
      _FormsScreenState();
}

class _FormsScreenState extends ConsumerState<ConsentAndComplianceFormsScreen>
