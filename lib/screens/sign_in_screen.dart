...
class _SignInScreenState extends ConsumerState<SignInScreen> {
  ...
  Widget _buildBranding(BuildContext context) {
    return Column(
      children: [
        Image.asset(PngAssets.splashLogo, height: context.w(100), width: context.w(100), fit: BoxFit.contain),
  ...
  Widget _getCurrentForm(BuildContext context) {
    switch (_currentScreen) {
      case AuthScreen.login: return _loginForm(context);
      case AuthScreen.forgetPassword: return _forgetPasswordForm(context);
      case AuthScreen.verifyOtp: return _verifyOtpForm(context);
      case AuthScreen.createNewPassword: return _createNewPasswordForm(context);
    }
  }
  ...
  Widget _loginForm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('Enter your credentials to access the admin panel.', style: context.fonts.grey13w500),
        context.verticalSpace(32),
        BuildTextField(
          label: 'Email Address',
          ...
          prefixIcon: Icon(Icons.alternate_email_rounded, size: context.sp(20), color: CustomColors.lightGrey),
        ),
        ...
        BuildTextField(
          ...
          prefixIcon: Icon(Icons.lock_outline_rounded, size: context.sp(20), color: CustomColors.lightGrey),
  ...
  Widget _forgetPasswordForm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        context.verticalSpace(8),
        Text("Enter your email and we'll send you an OTP code.", style: context.fonts.grey13w500),
        context.verticalSpace(32),
        BuildTextField(
  ...
  Widget _verifyOtpForm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        context.verticalSpace(8),
        Text("We've sent a 6-digit code to your email.", style: context.fonts.grey13w500),
        context.verticalSpace(32),
        Pinput(
  ...
  Widget _createNewPasswordForm(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        context.verticalSpace(8),
        Text('Your new password must be different from previous ones.', style: context.fonts.grey13w500),
        context.verticalSpace(32),
        ...
        ValueListenableBuilder(
          ...
          builder: (context, val, child) => BuildTextField(
            ...
            obscureText: val,
            prefixIcon: Icon(Icons.lock_reset_rounded, size: context.sp(20), color: CustomColors.lightGrey),
            suffixIcon: IconButton(
      ...
      children: [
        SizedBox(
          ...
          child: Checkbox(
            ...
            shape: RoundedRectangleBorder(borderRadius: context.borderRadius(all: 6)),
          ),
        ),
