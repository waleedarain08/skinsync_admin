...
class _AddNewClinicScreenState extends ConsumerState<AddNewClinicScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      CustomPrimaryButton(
                        onTap: _submit,
                        label: state.loading ? 'Saving...' : 'Register Clinic',
                        width: 180.w,
                      ),
                    ],
                  ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 16.h),
                            _buildAvailabilitySectionContent(),
                          ],
                        ),
                      ),
                    ],
  ...
  Widget _buildAvailabilitySectionContent() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          ...
          children: [
            Text(
              'Manage your operating hours and active days.',
