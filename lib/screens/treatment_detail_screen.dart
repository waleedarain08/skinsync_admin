...
//   Widget _buildProfileHeader(BuildContext context, TreatmentListData treatment, TreatmentDetailData? detail) {
...
//   Widget _buildPrimaryInfo(BuildContext context, TreatmentListData treatment) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         _infoSection(
...
//   Widget _buildSecondaryStats(BuildContext context, TreatmentListData treatment) {
//     return Column(
//       children: [
...
//   Widget _buildSessionsSection(BuildContext context, TreatmentListData treatment) {
...
//   Widget _buildConsentSection(BuildContext context, TreatmentListData treatment) {
...
//   Widget _buildDowntimeSection(BuildContext context, TreatmentListData treatment, TreatmentDetailData? detail) {
...
//   Widget _buildRolesSection(BuildContext context, TreatmentListData treatment) {
...
//   Widget _buildAreasAndLogic(BuildContext context, TreatmentListData treatment, TreatmentDetailData? detail) {
...
//   Widget _buildProductUsages(BuildContext context, TreatmentListData treatment) {
//     return CollapsibleSection(
...
//   Widget _buildPricingSection(BuildContext context, TreatmentListData treatment, TreatmentDetailData? detail) {
